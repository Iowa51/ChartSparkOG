...
CREATE POLICY "service_role_insert_telehealth_session_tokens"
...
CREATE POLICY "service_role_select_telehealth_session_tokens"
  ON public.telehealth_session_tokens
  FOR SELECT
  TO service_role
  USING (true);
...
CREATE POLICY "service_role_update_telehealth_session_tokens"
  ON public.telehealth_session_tokens
  FOR UPDATE
  TO service_role
  USING (true)
...
CREATE POLICY "service_role_delete_telehealth_session_tokens"
  ON public.telehealth_session_tokens
  FOR DELETE
  TO service_role
  USING (true);
