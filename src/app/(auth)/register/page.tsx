        ...
        try {
            ...
            const { data: authData, error: authError } = await supabase.auth.signUp({
                ...
                options: {
                    ...
                    emailRedirectTo: `${process.env.NEXT_PUBLIC_APP_URL || "https://chart-spark-og.vercel.app"}/auth/callback?org=${encodeURIComponent(organization.trim())}&next=${encodeURIComponent("/dashboard")}`,
                },
            });
