...
import { validateRequest, PatientDocumentUploadSchema } from '@/lib/validation/schemas';
...
async function handleGet(context: AuthContext) {
    try {
        ...
        const { data: documents, error } = await supabase
            ...
            .select('id, patient_id, document_type, file_name, file_size, mime_type, label, created_at, uploaded_by')
