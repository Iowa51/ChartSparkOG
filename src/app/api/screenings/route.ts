...
const ScreeningsListQuerySchema = z
  .object({
...
async function handleGet(context: AuthContext) {
  ...
  try {
    ...
    const queryParsed = ScreeningsListQuerySchema.safeParse(Object.fromEntries(searchParams));
    ...
    const { patient_id, encounter_id, instrument, limit } = queryParsed.data;
