...
async function handleGet(context: AuthContext) {
  ...
  try {
    ...
    const queryParsed = VitalsListQuerySchema.safeParse(Object.fromEntries(searchParams));
    ...
    const { patient_id, encounter_id, limit } = queryParsed.data;
    ...
    await logAuditEvent({
      ...
      details: {
        action: "VITALS_VIEW",
        hasPatientFilter: Boolean(patient_id),
        hasEncounterFilter: Boolean(encounter_id),
      },
      phiAccessed: true,
      riskLevel: "LOW",
    });
