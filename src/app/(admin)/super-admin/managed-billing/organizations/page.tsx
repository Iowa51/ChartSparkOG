        ...
        <div className="flex-1 p-6 lg:p-8 overflow-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    <button onClick={handleExportLeaderboard} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-black uppercase tracking-widest text-slate-600 dark:text-slate-400 hover:bg-slate-50 hover:border-purple-500 transition-all">
                        <BarChart3 className="h-4 w-4" />
                        Export Leaderboard
                    </button>
                    <button onClick={handleCrossOrgAudit} className="flex items-center gap-2 px-4 py-2 bg-purple-500 text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-lg shadow-purple-500/20 hover:bg-purple-500/90 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <button onClick={() => handleMetricClick('Avg. Yield Across Suite')} className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group hover:border-purple-500/50 hover:shadow-lg transition-all text-left cursor-pointer">
                ...
                <button onClick={() => handleMetricClick('Audit Coverage')} className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group hover:border-purple-500/50 hover:shadow-lg transition-all text-left cursor-pointer">
                    ...
                    <div className="mt-2 w-full h-1 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                        <div className="h-full bg-purple-500" style={{ width: "62.8%" }} />
                    </div>
                </button>
            </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-9 pr-4 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-black uppercase tracking-widest w-64 border-purple-500/20"
                            />
                        </div>
                            ...
                            {benchmarkData.map((org, i) => (
                                <tr key={i} className="group hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-all">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <button onClick={() => handleOrgDrilldown(org.name)} className="p-2 hover:bg-purple-500/10 text-slate-400 hover:text-purple-500 rounded-lg transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800">
                    ...
                    <div className="space-y-6">
                        <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl flex items-center justify-between border border-purple-500/10">
                            <div className="flex items-center gap-4">
                                <div className="h-10 w-10 bg-purple-500/20 rounded-xl flex items-center justify-center text-purple-500">
