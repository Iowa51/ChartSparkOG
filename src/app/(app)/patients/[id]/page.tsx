                    ...
                    <div className="p-6">
                        <div className="flex items-start justify-between">
                            <div className="flex items-center gap-4">
                                <div
                                    className={`h-16 w-16 rounded-full flex items-center justify-center text-xl font-bold ${patient.avatar_color || 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300'
                                        }`}
                                >
                                    {initials}
                                </div>
                                ...
                                <CardContent>
                                    <div className="space-y-3 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <span className={`inline-block px-2 py-1 rounded text-xs font-bold ${patient.status === 'active'
                                    ...
                                    <div className="space-y-2">
                                        {patient.medications.map((med) => (
                                            ...
                                            >
                                                ...
                                                <span className={`text-xs px-2 py-1 rounded font-bold uppercase ${med.status === 'active'
                                                    ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400'
                                                    : 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400'
                                                    }`}>
                                                    {med.status}
                                    ...
                                    <div className="space-y-2">
                                        {patient.problems.map((problem) => (
                                            ...
                                            >
                                                ...
                                                <span className={`text-xs px-2 py-1 rounded font-bold uppercase ${problem.status === 'active'
                                                    ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400'
                                                    : 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400'
                                                    }`}>
                                                    {problem.status}
