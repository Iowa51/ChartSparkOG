...
const allNotifications: Notification[] = [
  ...
  },
  {
    ...
    description:
      "Michael Chen's appointment is scheduled for 2:00 PM today. Review their notes before the session.",
    time: "1h ago",
    date: "Today",
    type: "appointment",
    read: false,
  ...
  },
  {
    ...
    description:
      "The Clinical AI Engine has been upgraded to version 2.4 with improved treatment plan recommendations and HIPAA compliance features.",
    time: "5h ago",
    date: "Today",
    type: "system",
    read: true,
  ...
  },
  {
    ...
    description:
      "SOAP note for Lisa Anderson (Follow-up visit) has been generated and is ready for your review and signature.",
    time: "Yesterday",
    date: "Jan 19",
    type: "document",
    read: true,
  ...
  },
  {
    ...
    description:
      "James Wilson has cancelled their 11:30 AM appointment scheduled for tomorrow. The slot is now available.",
    time: "Yesterday",
    date: "Jan 19",
    type: "appointment",
    read: true,
  ...
  },
  {
    ...
    description:
      "AI has generated an updated treatment plan for patient Robert Davis based on their latest PHQ-9 scores.",
    time: "2 days ago",
    date: "Jan 18",
    type: "document",
    read: true,
  ...
  },
  {
    ...
    description:
      "Dr. Emily Chen sent you a message regarding patient referral for Michael Thompson.",
    time: "2 days ago",
    date: "Jan 18",
    type: "system",
    read: true,
    ...
    const loadNotifications = () => {
      ...
      if (saved) {
        try {
          ...
          // Malformed localStorage payload (hand-edited, storage
          // corruption, or old schema) — fall back to the default
          // notifications without surfacing a user-visible error.
              ...
              <div className="space-y-2">
                {items.map((notification) => (
                  <div
                    ...
                    className={`group relative bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 transition-all hover:shadow-md hover:border-primary/50 dark:hover:border-primary/50 cursor-pointer ${
                      !notification.read ? "ring-2 ring-primary/20 bg-primary/5" : ""
                    }`}
                  >
                    <div className="flex gap-4">
                      <div
                        className={`p-3 rounded-xl shrink-0 ${notification.color} border border-current/10`}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start gap-2">
                          <h3
                            className={`text-sm font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors ${
