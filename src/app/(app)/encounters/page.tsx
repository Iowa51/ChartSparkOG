    ...
    const fetchEncounters = useCallback(async () => {
        ...
        try {
            ...
            if (statusFilter) {
                ...
                params.append('status', statusMap[statusFilter] || statusFilter.toLowerCase().replace(' ', '_'));
            }
                                            ...
                                            >
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3">
                                                        <div
                                                            className={`h-10 w-10 rounded-full flex items-center justify-center text-sm font-bold ${encounter.patient?.avatar_color || "bg-primary/10 text-primary"
                                                                }`}
                                                        >
                                                ...
                                                <td className="px-6 py-4">
                                                    <div>
                                                        <p className="text-sm text-foreground">{formatDate(encounter.encounter_date)}</p>
                                                        <p className="text-xs text-muted-foreground">{formatTime(encounter.encounter_date)}</p>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4">
