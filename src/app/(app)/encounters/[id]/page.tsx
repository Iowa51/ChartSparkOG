...
export default function EncounterDetailPage() {
    ...
    const providerName = encounter?.provider?.full_name || encounter?.provider?.email || "Unknown Provider";
            ...
            <div className="flex flex-col h-full bg-slate-50/50 dark:bg-slate-950/50">
                ...
                <div className="flex-1 p-6 lg:px-10 lg:py-8 max-w-5xl mx-auto w-full">
                    <div className="rounded-2xl border border-red-200 bg-red-50 p-6 text-red-700 dark:border-red-900/40 dark:bg-red-950/40 dark:text-red-300">
                        ...
                        <Link href="/encounters" className="mt-4 inline-flex items-center gap-2 text-sm hover:underline">
            ...
            <div className="flex-1 p-6 lg:px-10 lg:py-8 max-w-5xl mx-auto w-full space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            onClick={() => router.push(`/notes/new?encounterId=${encounter.id}&patientId=${encounter.patient_id}`)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-base font-bold text-foreground">{new Date(encounter.encounter_date).toLocaleDateString()}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-base font-bold text-foreground">{new Date(encounter.encounter_date).toLocaleTimeString([], { hour: "numeric", minute: "2-digit" })}</p>
                            </div>
                        </div>
                    </div>
                    <div className="absolute top-0 right-0">
                        <span className={`px-4 py-1.5 text-[10px] font-black uppercase tracking-widest border-l border-b rounded-bl-xl ${statusStyles[encounter.status] || statusStyles.scheduled}`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-card rounded-2xl border border-border p-6 shadow-sm">
                            <h3 className="text-sm font-black uppercase tracking-widest text-muted-foreground mb-4">Latest Note</h3>
                            {latestNote ? (
                                ...
                                <div className="space-y-3">
                                    <p className="text-foreground leading-relaxed">No note has been created for this encounter yet.</p>
                                    <Link
                                        href={`/notes/new?encounterId=${encounter.id}&patientId=${encounter.patient_id}`}
                                        className="inline-flex items-center gap-2 text-sm font-semibold text-primary hover:underline"
                                    >
