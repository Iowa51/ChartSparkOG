...
const routeSpecs: RouteSpec[] = [
  ...
  },
  {
    ...
    implemented: false,
    successResponse: "No list route exists even though multiple app pages try to call it.",
  ...
  },
  {
    ...
    requestedPath: "/api/encounters",
    implemented: false,
    successResponse: "No create route exists. The only encounter API in this app is /api/encounters/tracking.",
    validationErrors: ["404 Not Found"],
  },
  {
    area: "Encounters",
    ...
    implemented: false,
    successResponse: "No detail route exists even though the note editor tries to fetch it.",
    validationErrors: ["404 Not Found"],
  },
  {
    area: "Encounters",
    ...
    requestedPath: "/api/encounters/[id]",
    implemented: false,
    successResponse: "No update route exists. The closest implementation is POST /api/encounters/tracking.",
    validationErrors: ["404 Not Found"],
  },
  {
    area: "Notes",
  ...
  },
  {
    ...
    implemented: false,
    successResponse: "No agent pipeline route exists in src/app/api.",
    validationErrors: ["404 Not Found"],
  },
  {
    area: "Admin",
...
const auditIssues: AuditIssue[] = [
  ...
  },
  {
    ...
    summary: "Encounter list/detail/update endpoints are missing, but several app pages still call them.",
    status: "known-gap",
  },
  {
    severity: "high",
  ...
  },
  {
    ...
    summary: "Requested agent completion route does not exist in src/app/api.",
    status: "known-gap",
  },
  {
    severity: "medium",
